...
|:-------------------:|:---------------------:|:--------:|:------------------:|:----:|:------:|:-------:|:-------------------------------------------------------------------------------------------------------------------------------------------------:|
|      dmhy.org       |         dmhy          |   Slow   |         ✅          |  ✅   |   ✅    |    ❎    |                                                                       None                                                                        |
|      dmhy.org       |       dmhy_rss        | Moderate |         ✅          |  ❎   |   ✅    |    ❎    |                                                                       None                                                                        |
|       nyaa.si       |         nyaa          |   Fast   |         ❎          |  ✅   |   ✅    |    ✅    |                                                                       None                                                                        |
|       nyaa.si       |       nyaa_rss        |   Fast   |         ❎          |  ✅   |   ✅    |    ✅    |                                                                       None                                                                        |
|       acg.rip       |        acgrip         |   Fast   |         ❎          |  ✅   |   ❎    |    ✅    |                                                                       None                                                                        |
|       acg.rip       |      acgrip_rss       |   Fast   |         ❎          |  ❎   |   ❎    |    ✅    | Max search pages is 5, as more will be blocked by the server. You can modify the `MAX_PAGE` in the module, but it is not recommended to exceed 9. |
| www.tokyotosho.info |      tokyotosho       |   Fast   |         ❎          |  ✅   |   ✅    |    ✅    |                                                         Requires English/Japanese search                                                          |
